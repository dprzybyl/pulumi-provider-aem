...
This boilerplate creates a working Pulumi-owned provider named `aem`.
...
### Build & test the boilerplate AEM provider
...
1. Set the following options:
   * Owner: pulumi 
   * Repository name: pulumi-aem-native (replace "aem" with the name of your provider)
   * Description: Pulumi provider for aem
   * Repository type: Public
1. Clone the generated repository.

From the templated repository:

1. Search-replace `aem` with the name of your desired provider.
